package de.fhcom.speedomatik.ui;
...
import de.fhcom.speedomatik.core.Speedtest;
...
public class MainActivity extends Activity {
    ...
    private void page_serverSelect(TestPoint selected, TestPoint[] servers){
        ...
        TextView t2=(TextView)findViewById(R.id.licenses_open);
    ...
    private void page_privacy(int clicked){
        ...
        if (clicked == 1) {
            ...
            clicked = 0;
            ((WebView) findViewById(R.id.privacy_policy)).loadUrl(getString(R.string.licenses_site));
            TextView t = (TextView) findViewById(R.id.privacy_close);
            t.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
